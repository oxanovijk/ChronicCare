    ...
    <div className="caregiver-production-shell">
      ...
      <aside className="caregiver-production-sidebar">
        ...
        <nav aria-label="Navigasi caregiver">
          ...
          <Link href="/caregiver/chat" className={activeSection === "chat" ? "is-active" : undefined} aria-current={activeSection === "chat" ? "page" : undefined}><ChatCircleDots size={21} weight={activeSection === "chat" ? "fill" : "regular"} aria-hidden="true" /><span>Asisten</span></Link>
        </nav>
      ...
      <div className="caregiver-production-stage">
        ...
        <nav className="caregiver-production-mobile-nav" aria-label="Navigasi caregiver mobile">
          ...
          <Link href="/caregiver/chat" className={activeSection === "chat" ? "is-active" : undefined} aria-current={activeSection === "chat" ? "page" : undefined}><ChatCircleDots size={20} weight={activeSection === "chat" ? "fill" : "regular"} aria-hidden="true" /><span>Asisten</span></Link>
        </nav>
      </div>
    </div>
  );
