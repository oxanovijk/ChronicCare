    ...
    <div className="care-dashboard" id="daily-care">
      ...
      <div className="care-dashboard-columns">
        ...
        <aside className="care-dashboard-rail" aria-label="Konteks Packet 08">
          ...
          <section className="care-unavailable-card"><h2>Fitur berikutnya</h2><ul><li><span>Asisten caregiver</span><small>Belum tersedia</small></li><li><span>Faskes/BPJS</span><small>Belum tersedia</small></li></ul></section>
        </aside>
      </div>
    </div>
  );
